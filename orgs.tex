...
\begin{document}
\frame{\titlepage}
\begin{frame}[t,allowframebreaks]{Table of contents}\setbeamertemplate{section in toc}[sections numbered]
...
\begin{frame}{CIRDAP (Centre on Integrated Rural Development for Asia
and the Pacific)}
\protect\hypertarget{cirdap-centre-on-integrated-rural-development-for-asia-and-the-pacific}{}
\begin{itemize}
\tightlist
\item
