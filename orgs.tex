...
\begin{frame}[allowframebreaks]{Commonwealth of Nations}
...
\begin{frame}[allowframebreaks]{NAM (Non-Aligned Movement)}
...
\begin{frame}[allowframebreaks]{OIC (Organisation of Islamic Co-operation)}
...
\begin{frame}[allowframebreaks]{EU (European Union)}
