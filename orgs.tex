...
\section[Commonwealth of Nations]{Commonwealth of Nations}\begin{frame}[allowframebreaks]{Commonwealth of Nations}
...
\section[NAM (Non-Aligned Movement)]{NAM (Non-Aligned Movement)}\begin{frame}[allowframebreaks]{NAM (Non-Aligned Movement)}
...
\section[OIC (Organisation of Islamic Co-operation)]{OIC (Organisation of Islamic Co-operation)}\begin{frame}[allowframebreaks]{OIC (Organisation of Islamic Co-operation)}
...
\section[EU (European Union)]{EU (European Union)}\begin{frame}[allowframebreaks]{EU (European Union)}
...
\section[AU (African Union)]{AU (African Union)}\begin{frame}[allowframebreaks]{AU (African Union)}
