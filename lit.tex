...
\item
  ...
  \item
    ...
    \banglatext{লিলি মার সাথে ফ্রান্স স্পেনে ঘুরছে})
    ...
    \item
      ...
      \tightlist
      \item
        \banglatext{মার} \(\rightarrow\) \emph{Marlowe}
      \item
        \banglatext{ঘরে} \(\rightarrow\) Robert \emph{Greene}
      \item
        \banglatext{ছেলে} \(\rightarrow\) Thomas \emph{Kyd}
      \item
        \banglatext{পেলে} \(\rightarrow\) George \emph{Peele}
      \item
        \banglatext{নাচে} \(\rightarrow\) Thomas \emph{Nashe}
      \item
        \banglatext{ল} \(\rightarrow\) Thomas \emph{Lodge}
      \item
        \banglatext{লি} \(\rightarrow\) John \emph{Lyly}
      \end{itemize}
    \item
      Shakespeare
    \item
